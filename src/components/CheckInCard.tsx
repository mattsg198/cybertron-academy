...
export default function CheckInCard() {
  ...
  return (
    <div className="relative mx-auto flex w-full max-w-4xl items-center gap-4 rounded-2xl border border-white/10 bg-white/5 px-4 py-2.5">
      {/* streak */}
      ...
      <AnimatePresence>
        {reward && (
          <motion.div
            ...
            exit={{ opacity: 0 }}
            className="pointer-events-none absolute right-6 top-1 text-lg font-black text-energon"
          >
            +{reward} ⚡
          </motion.div>
        )}
